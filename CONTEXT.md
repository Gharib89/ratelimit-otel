...
- [ADR-0003](docs/adr/0003-sample-every-session-with-an-identity-ladder.md) — sample every session including CI, with an identity ladder. Amended: a cloud sandbox is unreachable by measurement; a session ending is sampled. Its triggers and delivery floor are superseded by ADR-0005.
